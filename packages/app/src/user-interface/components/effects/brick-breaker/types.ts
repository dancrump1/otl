...
export interface BrickBreakerLayout {
 ...
 sidePadding: number
 /** Height of the brick field (ratio of canvas height) */
 playAreaHeight: number
 /** When `contain`, the brick field is centered and keeps `brickFieldAspect`. */
 brickFieldFit: 'stretch' | 'contain'
 /** Width / height of the contained brick field. Ignored when fit is `stretch`. */
 brickFieldAspect: number
...
export interface BrickBreakerProps {
 ...
 /** Optional artwork used as brick faces */
 imageSrc?: string
}
