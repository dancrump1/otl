...
- Add to NGINX configs:
      ...
      `
        # Add as a MAIN type 
        # ADMIN GUIDE DEFAULT ROUTE OVERRIDE 
        location /admin/usermanual {
            return 301 /usermanual;
        }
      `
      `
        # Add as a HEADER type
        location ~* /publicFiles/ {
          if ($request_method = GET) {
            add_header Access-Control-Allow-Origin <https://dev.cannonmt.drivedev.net>;
          }
        }
      `
